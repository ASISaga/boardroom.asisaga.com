 ...
 * The resulting token is stored in sessionStorage and attached as a
...
const AUTH_TOKEN_KEY = 'boardroom_auth_token';
...
class BoardroomApp extends ChatroomApp {
    constructor() {
        ...
        // Auth state
        this.authToken = sessionStorage.getItem(AUTH_TOKEN_KEY) || null;
    }
